...
public class FileServer {
    ...
    private FileServerEndPoints.Processor<FileServerEndPointsImpl> fileServerServiceProcessor;
    ...
    public FileServer(String coordinatorHostname) {
        ...
        FileServerEndPointsImpl fileServerEndPoints = new FileServerEndPointsImpl(coordinator);
        this.fileServerServiceProcessor = new FileServerEndPoints.Processor<FileServerEndPointsImpl>(fileServerEndPoints);
    }
