...
/**
 * Created by zhexuany on 3/25/16.
 */
...
public class Coordinator {
    ...
    private CoordinatorEndPoints.Processor<CoordinatorEndPointsImpl> coordinatorServiceProcessor;
    private TServer server = null;
    private TServerTransport serverTransport = null;

    public Coordinator(int nr, int nw, long syncInterval) {
        CoordinatorEndPointsImpl coordinatorEndPoints = new CoordinatorEndPointsImpl(nr, nw, syncInterval);
        this.coordinatorServiceProcessor = new CoordinatorEndPoints.Processor<CoordinatorEndPointsImpl>(coordinatorEndPoints);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            fileServer.startService(coordinatorHost, port, coordinatorHost);
